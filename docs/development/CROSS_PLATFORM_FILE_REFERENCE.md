...
This companion inventory extends [`REPOSITORY_FILE_REFERENCE.md`](REPOSITORY_FILE_REFERENCE.md) for the universal cross-platform surface. It is intentionally narrow: every directory prefix identifies one concrete project, and root-level additions are listed exactly.
