...
public sealed class Account : Entity
{
    ...
    public long? ReconciledBalanceMinor { get; set; }
    public List<FinanceTransaction> Transactions { get; set; } = [];
}

public sealed class FinanceTransaction : Entity
{
...
public sealed class TransactionSplit : Entity
{
...
public sealed class BudgetPeriod : Entity
{
    ...
    public long PlannedMinor { get; set; }
    public long RolloverMinor { get; set; }
}
...
public sealed class SavingsGoal : Entity
{
    ...
    public long StartingMinor { get; set; }
    public string Currency { get; set; } = "INR";
...
public sealed class RecurrenceOccurrence : Entity
{
    public Guid RecurrenceRuleId { get; set; }
    ...
    public DateOnly? PostponedTo { get; set; }
}
...
public sealed class Attachment : Entity
{
    ...
    public string OriginalFileName { get; set; } = "receipt";
    public required string ContentType { get; set; }
    public long SizeBytes { get; set; }
    public byte[]? Sha256 { get; set; }
}

public sealed class TransactionRevision : Entity
{
    public Guid TransactionId { get; set; }
    public FinanceTransaction? Transaction { get; set; }
...
public sealed class AccountReconciliation : Entity
{
    public Guid AccountId { get; set; }
    public Account? Account { get; set; }
    public DateTimeOffset StatementDateUtc { get; set; }
    public long BookBalanceMinor { get; set; }
    public long StatementBalanceMinor { get; set; }
...
public sealed class BackupMetadata : Entity
{
